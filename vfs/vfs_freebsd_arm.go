// Code generated by 'ccgo -o vfs__.go c/vfs.c -I../testdata/sqlite-amalgamation-3390300 -lgithub.com/litesql/sqlite/lib -pkgname vfs -nocapi -export-externs X -D SQLITE_OS_UNIX -hide=vfsFullPathname -hide=vfsOpen -hide=vfsRead -hide=vfsAccess -hide=vfsFileSize -hide=vfsClose', DO NOT EDIT.
